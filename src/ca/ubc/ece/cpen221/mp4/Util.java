...
public final class Util {
	 ...
	 * @param location
	 *            the location to be checked on validity
	 ...
	 *            the current World
	 * @param startW
	 *            the starting x-coordinate (x-coordinate of the top-left corner
	 *            of the bounding box)
	 * @param startH
	 *            the starting y-coordinate (y-coordinate of the top-left corner
	 *            of the bounding box)
	 * @param width
	 ...
	 *         location exists
	 */
	public static Location getRandomEmptyLocation(World world, int startW, int startH, int width, int height) {
	 ...
	 *            the current World
	 * @param location
	 *            the Location to be checked on emptiness
